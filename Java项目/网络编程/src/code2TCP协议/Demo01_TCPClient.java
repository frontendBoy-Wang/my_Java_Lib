...
TCP通信的客户端:向服务器发送连接请求，给服务器发送数据,读取服务器回写的数据
        ...
        实现步骤:
            ...
            2.使用Socket对象中的方法getOutputStream()获取网路字节输出流OutputStream对象
            3.使用网路字节输出流OutputStream对象中的方法write,给服务器发送数据
            4.使用Socket对象中的方法getInputStream( )获职网络字节输入流InputStream对象
            5.使用网络字节输，入流InputStream对象中的方法read,读取服务器回写的数据
            6.释放资源(Socket)
